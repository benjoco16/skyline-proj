...
$('.ptp-item-container > .ptp-plan').each(function(){
    $(this).next('.ptp-price').andSelf().wrapAll('<div class="price-header"/>');
});

//jQuery('.ptp-four-col').hover(function(){
    //jQuery(this).find('.ptp-bullet-item, .ptp-cta').slideToggle('slow');
//})
